...
breaking_bad_e1_s1 = Episode('Pilot',
                             "Walter White, a 50-year old chemistry teacher, \
                             secretly begins making crystallized \
                             methamphetamine to support his family after \
                             learning that he has terminal lung cancer. He \
                             teams up with a former student, Jesse Pinkman, \
                             who is a meth dealer. Jesse tries to sell the \
                             meth they made, but the dealers snatch him and \
                             make him show them their lab, which is in an old \
                             RV. Walt knows the dealers intend to kill him, \
                             so he poisons them while pretending to share his \
                             recipe.", 58, 1, 1)

breaking_bad_e2_s1 = Episode('Cats in the Bag',
                             "Walt and Jesse try to dispose of the two bodies \
